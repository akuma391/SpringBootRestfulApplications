...
@ComponentScan(basePackages= {"hello.controller","com.infotech.book.ticket.app.service","com.infotech.book.ticket.app.entities","com.infotech.book.ticket.app.dao"})
// all the packages should be defined under somponent scan if location of one is changed
