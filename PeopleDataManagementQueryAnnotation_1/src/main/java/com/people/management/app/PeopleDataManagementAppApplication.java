...
public class PeopleDataManagementAppApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
 	//findInfoByLastName();
	findInfoByLastNameAndEmail();
	}

	private void findInfoByLastNameAndEmail() {
		List<People> peopleList =  peopleManagementService.findInfoByLastNameAndEmail("Harry","hd@yahoo.com");
		peopleList.forEach(System.out::println);
	}

	private void findInfoByLastName() {
		
	List<People>	peopleList = peopleManagementService.findInfoByLastName("Daniel");
	peopleList.forEach(System.out::println);
	}
